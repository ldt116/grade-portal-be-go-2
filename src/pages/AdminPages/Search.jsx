    ...
    <div className="bg-[#ECE8E8] border-t-4 border-[#0B4DC8] py-7 px-6">
      ...
      <div className="flex my-12 justify-between">
        <div className="border border-black bg-white rounded-3xl">
          <label htmlFor="mssv" className="border-r border-black py-[0.3125rem] px-4">Mã Lớp</label>
          <input type="number" placeholder="Nhập mã lớp" id="mssv" className="pl-4 py-1 rounded-e-3xl"></input>
        </div>
        <div className="border border-black bg-white rounded-3xl">
